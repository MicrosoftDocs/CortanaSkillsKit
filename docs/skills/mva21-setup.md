...
* Make sure your PC or Mac has the necessary development tools and operating system version. Note that Cortana currently supports only one locale: English-U.S. (en-US).
* Set up Cortana.
