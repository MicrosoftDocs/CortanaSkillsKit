...
Your client secret is the `MicrosoftAppPassword` from when you created your bot. As of the time this is written (spring 2019), this password expires after two years.
